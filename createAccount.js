...
function createAccount(_numAccounts) {
  for (let count=1; count <= _numAccounts; count++ ) {
    ...
    logAccount(walletRandom, "From Random");
    ...
    logAccount(walletPhrase, "From Mnemonic");
    ...
    logAccount(walletPrivate, "From Private");
  }
}
...
function logAccount(wallet, msg) {
console.log(`*** ${msg} ***`);
